...
typedef enum {
    AgentCallTargetAgent,      //坐席id
    AgentCallTargetTel,        //普通电话
    AgentCallTargetLineNumber, //ip电话
    AgentCallTargetOneNumber   //一号通
}AgentCallTarget;
...
@property (nonatomic, readonly) QAgentInfo *currentAgentInfo;
